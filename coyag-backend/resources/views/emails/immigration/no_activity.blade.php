...
@section('template_text')
    ...
    <tr>
        <td bgcolor="#ffffff" align="left" style="padding: 10px 30px 20px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
            <p style="margin: 0;">Esta semana no hubo novedades en su <b>Cuenta de Extranjería</b>.</p>
        </td>
    </tr>

    <tr>
        <td bgcolor="#ffffff" align="left" style="padding: 10px 30px 20px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
            <p style="margin: 0;">Usted posee <b>{{ $completeVS }} pasos completados de {{ $totalVS }}</b> esto representa un avance de <b>{{ round(($completeVS / $totalVS) * 100, 0) }}%</b> en su visado tipo <b>{{ $nameVisaType }}</b>.</p>
        </td>
    </tr>

    <tr>
        <td bgcolor="#ffffff" align="left" style="padding: 10px 30px 20px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
            <p style="margin: 0;">Por último, usted tiene <b>{{ $pendingDocsUpload }} archivos pendientes</b> por cargar en nuestra plataforma.</p>
        </td>
    </tr>
